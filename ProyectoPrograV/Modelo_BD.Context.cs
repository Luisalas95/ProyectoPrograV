...
namespace ProyectoPrograV
{
    ...
    public partial class tiusr5pl_Proyecto1PrograVEntities : DbContext
    {
        ...
        public virtual int InsertarEstudiante(string tipoid, string id, string nombre, string primerApellido, string segundoApellido, Nullable<System.DateTime> fechaNacimiento, ObjectParameter codigo)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertarEstudiante", tipoidParameter, idParameter, nombreParameter, primerApellidoParameter, segundoApellidoParameter, fechaNacimientoParameter, codigo);
        }
    }
}
